...
var con5;
var rope;
var meat,tiger_img,star_img,bg_img,tiger,tiger_animation, meat_img;

function preload()
{
  bg_img = loadImage('Zoo.png');
  meat_img = loadImage('meat.png');
...
function setup() {
  ...
  tiger_animation = loadAnimation('T1.png','T2.png','T3.png','T4.png','T5.png','T6.png','T7.png','T8.png');
...
function draw() 
{
  ...
  imageMode(CENTER);
  if(meat!=null){
    image(meat_img,meat.position.x,meat.position.y,70,70);
  }
  pop();
...
if(collide(meat,tiger,40) == true)
    {
      ...
      tiger.setAnimation(tiger_animation);
